export const subscriptionPlans = [
  {
    ...
    description: 'Быстрый расчет по объекту, каталог материалов и базовый контроль закупок.',
  ...
  },
  {
    ...
    description: 'Аналитика, согласование закупок, контроль отклонений и совместная работа по объектам.',
  ...
  },
  {
    ...
    description: 'Полная управленческая витрина для крупных подрядчиков и нескольких площадок.',
