...
const premiumSignals = [
  ...
  ['1 окно', 'для объекта, сметы и закупки'],
];
...
const userWorkflow = [
  ...
  {
    title: 'Закупка',
    text: 'Переведите смету в закупку и выберите поставщиков без ручного переноса данных.',
  },
  {
    title: 'Контроль',
    text: 'Смотрите статусы, согласовывайте закупку и контролируйте план / факт.',
  },
];
